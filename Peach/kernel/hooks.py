...
from Peach.evaluation import flatten_results_dict
from Peach.solver import LRMultiplier
from Peach.solver import LRScheduler as _LRScheduler
from Peach.utils.events import EventStorage, EventWriter
...
class PeriodicCheckpointer(_PeriodicCheckpointer, HookBase):
    """
    Same as :class:`Peach.checkpoint.PeriodicCheckpointer`, but as a hook.
...
class TorchProfiler(HookBase):
    ...
    ::
        hooks.TorchProfiler(
             lambda trainer: 10 < trainer.iter < 20, self.cfg.LOG+EXP
        )
    ...
    def after_step(self):
        ...
        if not self._save_tensorboard:
            ...
            if "://" not in out_file:
                ...
                with tempfile.TemporaryDirectory(prefix="Peach_profiler") as d:
...
class EvalHook(HookBase):
    ...
    def __init__(self, eval_period, eval_function, pre_val=False, eval_after_train=True):
        """
        Args:
