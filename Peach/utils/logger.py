...
def setup_logger(
    ...
    *,
    ...
    """
    Initialize the Peach logger and set its verbosity level to "DEBUG".
    ...
    Args:
        ...
        abbrev_name (str): an abbreviation of the module, to avoid long names in logs.
            ...
            By default, will abbreviate "Peach" to "ph" and leave other
            modules unchanged.
    ...
    if abbrev_name is None:
        abbrev_name = "PH" if name == "Peach" else name
...
def _log_api_usage(identifier: str):
    """
    Internal function used to log the usage of different Peach components
    inside facebook's infra.
    """
    torch._C._log_api_usage_once("Peach." + identifier)
