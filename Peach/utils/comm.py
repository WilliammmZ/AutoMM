...
_MISSING_LOCAL_PG_ERROR = (
    "Local process group is not yet created! Please use Peach's `launch()` "
...
def create_local_process_group(num_workers_per_machine: int) -> None:
    ...
    launch() in kernel/launch.py will call this function. If you start
