...
def collect_env_info():
    ...
    try:
        ...
        data.append(
            ("AutoMM", Peach.__version__ + " @" + os.path.dirname(Peach.__file__))
        )
    except ImportError:
        data.append(("Peach", "failed to import"))
    except AttributeError:
        data.append(("Peach", "imported a wrong installation"))
...
if __name__ == "__main__":
    try:
        from Peach.utils.collect_env import collect_env_info as f
